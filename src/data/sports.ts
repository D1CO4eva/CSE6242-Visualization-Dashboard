...
export const sportsData: Record<SportId, SportData> = {
  ...
  mlb: {
    ...
    name: 'Baseball',
    acronym: 'MLB',
    summary: 'Ridge regression predicting WAR: baseline (5 feats) vs. expanded (adds plate-discipline)',
    insight: 'Baseline ridge (barrel%, hit speed, sprint speed, height, weight) reaches test R² = 0.255. Adding plate-discipline features (K%, BB%, Hard%) lifts test R² to 0.480 — the +0.225 jump comes entirely from skill, not from adding physical traits. In the expanded model, brl_percent (coef 0.476) and K% (coef −0.472) dominate. Height has a negative coefficient (−0.077) — taller hitters produce slightly less WAR — and weight is essentially zero (0.005). Sprint speed (coef 0.237) is the only physical trait that meaningfully predicts WAR, and even it trails contact quality and plate discipline.',
    baselineRSquared: 0.255,
    enhancedRSquared: 0.480,
    baselineLabel: 'Baseline R² (5 feats)',
    enhancedLabel: 'Expanded R² (+discipline)',
    topPhysicalPredictor: 'Sprint Speed',
    weakestCorrelation: 'Weight → WAR (coef 0.005)',
    features: [
      { id: 'barrel', name: 'Barrel % (Contact Quality)', category: 'skill', baseline: 26.6, enhanced: 29.2 },
      { id: 'krate', name: 'K% (Plate Discipline)', category: 'skill', baseline: 0, enhanced: 28.9 },
      { id: 'hit_speed', name: 'Avg Exit Velocity', category: 'skill', baseline: 39.2, enhanced: 8.7 },
      { id: 'sprint', name: 'Sprint Speed', category: 'physical', baseline: 15.8, enhanced: 14.5 },
      { id: 'height', name: 'Height (in)', category: 'physical', baseline: 16.2, enhanced: 4.7 },
    ],
  },
  nfl: {
    id: 'nfl',
